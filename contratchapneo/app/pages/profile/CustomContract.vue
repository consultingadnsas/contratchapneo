    ...
    <main class="main-content">
      ...
      <header class="dashboard-header">
        <div v-if="authStore.user">
          <p class="greeting">Bonjour, {{ authStore.user?.username ?? 'invité' }}</p>
        </div>
        <div v-else>
          <p>Chargement...</p>
        </div>       
...
import userCustomedContract from '../../components/sections/userSection/userCustomedContract.vue'
export default {
